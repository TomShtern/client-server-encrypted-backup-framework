...
echo Building detailed RSA test...
"%CL_PATH%" /EHsc /D_WIN32_WINNT=0x0601 /std:c++17 /DCRYPTOPP_DISABLE_ASM=1 /I"client\include" /I"client\config" /I"crypto++" test_rsa_detailed.cpp client\src\RSAWrapper.cpp client\src\Base64Wrapper.cpp build\crypto++\*.obj ws2_32.lib advapi32.lib user32.lib gdi32.lib shell32.lib /Fe:test_rsa_detailed.exe

if %ERRORLEVEL% EQU 0 (
    echo Build successful! Running test...
    echo.
    test_rsa_detailed.exe
) else (
    echo Build failed!
)
